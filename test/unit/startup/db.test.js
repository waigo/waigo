...
const _ = require('lodash'),
  ...
  'otherwise sets up the db': function *() {
    yield this.setup(this.App)_.get(this.App.dbs, 'main.0').must.eql('main')_.get(this.App.dbs, 'main.2').must.eql({ type: 'test3', hello: 'world' })_.get(this.App.dbs, 'main2.0').must.eql('main2')_.get(this.App.dbs, 'main2.2').must.eql({ type: 'test3', hello: 'world' })this.App.db.must.eql(this.App.dbs.main)}    
}