...
const _ = require('lodash'),
  ...
  'fail': {
    beforeEach: function *() {
      ...
      })this.postConfig.startupSteps = ["step1", "step3"]yield this.initApp()},
  ...
  'fail': {
    beforeEach: function *() {
      ...
      })this.postConfig.shutdownSteps = ["step1", "step3"]yield this.initApp()yield this.App.start(this.startOptions)},
