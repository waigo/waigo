...
var loader = require('../../src/loader')test.beforeEach = function *() {
  ...
  beforeEach: function *() {
    ...
    }this.deletePackageJson()this.deleteTestFolders()this.createTestFolders()this.createPluginModules('waigo-plugin-1_TESTPLUGIN')this.createPluginModules('waigo-plugin-2_TESTPLUGIN')this.createPluginModules('another-plugin_TESTPLUGIN')this.createAppModules({
      'pluginConfig': 'module.exports = { dependencies: {"waigo-plugin-1_TESTPLUGIN": "0.0.1"} }'
    })},
  afterEach: function *() {
    this.deletePackageJson()this.deleteTestFolders()},
  ...
  'fails if not initialised': function *(){
    this.expect(() => {
      loader.getPath()}).to.throw('Please initialise Waigo first')},
  'once inititialised': {
    beforeEach: function *() {
